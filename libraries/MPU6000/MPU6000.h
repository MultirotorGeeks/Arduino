...
public:
	...
	_lAccum GetAccelX(void);				// returns latest read x-axis accelerometer measurement (does not perform a new read), m/s^2.  The data type _lAccum implies it is stored with a factor of 2^24.
	_lAccum GetAccelY(void);				// returns latest read y-axis accelerometer measurement (does not perform a new read), m/s^2.  The data type _lAccum implies it is stored with a factor of 2^24.
	_lAccum GetAccelZ(void);				// returns latest read z-axis accelerometer measurement (does not perform a new read), m/s^2.  The data type _lAccum implies it is stored with a factor of 2^24.

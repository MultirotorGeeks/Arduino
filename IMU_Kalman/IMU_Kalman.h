...
#define XGYRO_ANGLEPROCVAR	itolk(1)>>1		// X-axis gyro angle process variance of 1/4 rad
#define YGYRO_ANGLEPROCVAR	itolk(1)>>1		// Y-axis gyro angle process variance of 1/4 rad
#define ZGYRO_ANGLEPROCVAR	itolk(1)>>1		// Z-axis gyro angle process variance of 1/4 rad
#define XGYRO_ANGLEOBSVAR	itolk(1)>>3		// X-axis gyro angle observation variance of 1/4 rad
#define YGYRO_ANGLEOBSVAR	itolk(1)>>3		// Y-axis gyro angle observation variance of 1/4 rad
#define ZGYRO_ANGLEOBSVAR	itolk(1)>>3		// Z-axis gyro angle observation variance of 1/4 rad
#define XGYRO_RATEPROCVAR	itolk(1)>>4		// X-axis gyro rate process variance of 1/4 rad/sec
#define YGYRO_RATEPROCVAR	itolk(1)>>4		// Y-axis gyro rate process variance of 1/4 rad/sec
#define ZGYRO_RATEPROCVAR	itolk(1)>>4		// Z-axis gyro rate process variance of 1/4 rad/sec
